...
final class AgendaRepositoryTests: XCTestCase {
    ...
    func test_getAllEvents_Success() async throws {
    ...
    func test_getAllEventsTypes_Success() async throws {
        // GIVEN
    ...
    func test_getAllEventsTypes_fetchError() async throws {
        // GIVEN
        agendaSource.fetchAllEventsTypesReturnData = nil
    ...
    func test_getAllBirthdays_fetchError() async throws {
        // GIVEN
        agendaSource.fetchAllBirthdayReturnData = nil
    ...
    func test_getAllBirthdays_Success() async throws {
        let dateFormatter = DateFormatter()
